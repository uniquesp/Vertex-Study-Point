    ...
    <section class="main">
        ...
        <div class="main--container">
            <div class="section--title">
                <h3 class="title">Report Student-Wise :</h3>
                 <a href="../Admin/report.jsp"><button class="button" style="font-size:100%;">
                Report Hall-Wise</button></a>
            </div>
...
<%
    ...
    ResultSet resultset = statement.executeQuery("select * from student order by date_registered") ;
%>
