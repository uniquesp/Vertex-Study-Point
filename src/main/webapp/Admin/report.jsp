    ...
    <section class="main">
        ...
        <div class="main--container">
            <div class="section--title">
                <h3 class="title">Report Hall-Wise :</h3>
                <a href="../Admin/reportStudWise.jsp"><button class="button" style="font-size:100%;">
                Report Student-Wise</button></a>
            </div>
...
<%
    ...
    ResultSet resultset = statement.executeQuery("select * from reading_hall") ;
%>
<th>ID</th>
